...
export const TwoColumnTemplate: React.FC<TemplateProps> = ({ resumeData }) => {
  ...
  return (
    <div
      className="flex flex-col md:flex-row gap-6 p-6 max-w-4xl mx-auto bg-white text-gray-800"
      style={{
        fontSize:
    ...
    >
      ...
      <div className="md:w-1/3 space-y-6">
        ...
        <div>
          <h2
            className={`text-xl font-semibold mb-2 text-${customization.sectionTitleAlignment}`}
            style={{ color: customization.primaryColor }}
          >
            Skills
          </h2>
