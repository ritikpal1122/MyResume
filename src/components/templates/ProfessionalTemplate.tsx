...
export const ProfessionalTemplate: React.FC<TemplateProps> = ({ resumeData }) => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white shadow-lg">
      <header className={`text-${customization.nameAlignment} mb-6`}>
        ...
        <p className="text-xl font-semibold" style={{ color: customization.secondaryColor }}>{personalInfo.title}</p>
      </header>
      ...
      <section className="mb-6">
        <h2 className={`text-2xl font-bold mb-2 text-${customization.sectionTitleAlignment}`} style={{ color: customization.primaryColor }}>Professional Summary</h2>
        <p className="text-justify">{personalInfo.summary}</p>
      </section>

      <section className="mb-6">
        <h2 className={`text-2xl font-bold mb-2 text-${customization.sectionTitleAlignment}`} style={{ color: customization.primaryColor }}>Professional Experience</h2>
      ...
      <section className="mb-6">
        <h2 className={`text-2xl font-bold mb-2 text-${customization.sectionTitleAlignment}`} style={{ color: customization.primaryColor }}>Skills & Expertise</h2>
      ...
      <section>
        <h2 className={`text-2xl font-bold mb-2 text-${customization.sectionTitleAlignment}`} style={{ color: customization.primaryColor }}>Key Projects</h2>
