...
export const ClassicTemplate: React.FC<TemplateProps> = ({ resumeData }) => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white shadow-lg">
      <header
        className={`text-${customization.nameAlignment} mb-6 border-b pb-4`}
      >
        <h1
      ...
      <section className="mb-6">
        <h2
          className={`text-xl font-serif font-semibold mb-2 text-${customization.sectionTitleAlignment} border-b`}
          style={{ color: customization.primaryColor }}
        >
          Summary
        </h2>
